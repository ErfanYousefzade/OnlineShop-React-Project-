      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <nav className="hidden md:flex h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            <Link to="/CartItem" className="relative px-4 py-2 rounded-lg hover:bg-slate-700 transition">
              Cart
              {sum > 0 && (
            ...
            <Link to="/Admin" className="px-4 py-2 rounded-lg bg-violet-600 hover:bg-violet-700 transition">
              Admin
            </Link>
          </div>
